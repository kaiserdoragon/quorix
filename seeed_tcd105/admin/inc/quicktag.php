...
function add_quicktag_tab_label( $tab_labels ) {
	$tab_labels['quicktag'] = __( 'Quick tag', 'tcd-seeed' );
	return $tab_labels;
}
...
function add_quicktag_dp_default_options( $dp_default_options ) {
  ...
  $dp_default_options['qt_speech_balloon1_user_image'] = '';
	$dp_default_options['qt_speech_balloon1_user_name'] = __('User name', 'tcd-seeed');
  ...
  // 吹き出し2
	...
	$dp_default_options['qt_speech_balloon2_user_name'] = __('User name', 'tcd-seeed');
  ...
  // 吹き出し3
	...
	$dp_default_options['qt_speech_balloon3_user_name'] = __('User name', 'tcd-seeed');
  ...
  // 吹き出し4
	...
	$dp_default_options['qt_speech_balloon4_user_name'] = __('User name', 'tcd-seeed');
  ...
  // プラン一覧
	$dp_default_options['plan_list'] = array();
...
<div id="tab-content-quicktag" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac active open custon_post_usage_option">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="theme_option_message2">
      <p><?php _e( 'If you don\'t want to use quicktags included in the theme, please uncheck the box below.', 'tcd-seeed' ); ?></p>
     </div>
     <p><label><input name="dp_options[use_quicktags]" type="checkbox" value="1" <?php checked( 1, $options['use_quicktags'] ); ?>><?php _e( 'Use quicktags', 'tcd-seeed' ); ?></label></p>
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="theme_option_message2">
      <p><?php _e( 'These settings will be reflected in the quick tag button on the edit screen.', 'tcd-seeed' ); ?></p>
     </div>

     <?php for ( $i = 2; $i <= 5; $i++ ) : ?>
     <div class="sub_box cf qt-hn-preview-wrapper">
      <h3 class="theme_option_subbox_headline"><?php printf( __( 'H%d tag', 'tcd-seeed' ), $i ); ?></h3>
      <div class="sub_box_content">

       <?php // 見出しのプレビュー ?>
       <div class="admin_preview_area qt-hn-preview">
        <div class="qt_heading"><span><?php _e('Headline design', 'tcd-seeed'); ?></span></div>
       </div>
       ...
       <h4 class="theme_option_headline2"><?php _e( 'Border setting', 'tcd-seeed' ); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Display position', 'tcd-seeed'); ?></span>
        ...
        <li class="cf"><span class="label"><?php _e('Border style', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_h'.$i.'_border_style', $border_style_options); ?></li>
        ...
        <li class="cf">
         <span class="label"><?php _e('Border width', 'tcd-seeed'); ?></span>
       ...
       <div class="theme_option_message2">
        <p><?php _e( 'If you set the border style to "Double", please set the border width to 3px or more.', 'tcd-seeed' ); ?></p>
       </div>
      ...
      <div class="sub_box_content">
       ...
       <div class="admin_preview_area qt-btn-preview">
        <div class="qt_button_wrap">
         <div class="qt_button type1"><span class="text"><?php _e('Normal', 'tcd-seeed'); ?></span><span class="background"></span></div>
         <div class="qt_button type2"><span class="text"><?php _e('Ghost', 'tcd-seeed'); ?></span><span class="background"></span></div>
         <div class="qt_button type3"><span class="text"><?php _e('Reverse', 'tcd-seeed'); ?></span><span class="background"></span></div>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-seeed' ); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Type', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_type', $button_type_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Shape', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_border_radius', $button_border_radius_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Size', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_size', $button_size_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Mouseover animation', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_animation_type', $button_animation_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Color scheme', 'tcd-seeed'); ?></span><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color'] ); ?>" data-default-color="<?php echo esc_attr($main_color); ?>" class="c-color-picker"></li>
        <li class="cf"><span class="label"><?php _e('Color scheme on mouseover', 'tcd-seeed'); ?></span><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color_hover]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color_hover'] ); ?>" data-default-color="<?php echo esc_attr($main_color); ?>" class="c-color-picker"></li>
       </ul>
   ...
   <?php // 囲み枠 --------------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Frame style', 'tcd-seeed'); ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf qt-frame-preview-wrapper">
      <h3 class="theme_option_subbox_headline"><?php echo __('Frame style', 'tcd-seeed').$i; ?></h3>
      <div class="sub_box_content">
       ...
       <div class="admin_preview_area qt-frame-preview">
        <div class="qt_frame">
         ...
         <p><?php _e('The frame has the effect of making the text stand out.</br>Labels can be displayed in the upper left corner.', 'tcd-seeed'); ?></p>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e('Label', 'tcd-seeed'); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Label', 'tcd-seeed'); ?></span><input class="full_width" name="dp_options[qt_frame<?php echo $i; ?>_label]" type="text" value="<?php echo esc_attr( $options['qt_frame'.$i.'_label'] ); ?>"></li>
        <li class="cf"><span class="label"><?php _e('Font color', 'tcd-seeed'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_label_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_label_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
       </ul>
       <div class="theme_option_message2">
        <p><?php _e( 'Labels can also be changed from the edit screen of each article, and those set individually will take precedence.', 'tcd-seeed' ); ?></p>
       </div>

       <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-seeed'); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Background color', 'tcd-seeed'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_content_bg_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_content_bg_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
        <li class="cf"><span class="label"><?php _e('Shape', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_frame'.$i.'_content_shape', $flame_border_radius_options); ?></li>
        <li class="cf">
         <span class="label"><?php _e('Border width', 'tcd-seeed'); ?></span>
         <label class="number_option">
        ...
        <li class="cf"><span class="label"><?php _e('Border color', 'tcd-seeed'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_content_border_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_content_border_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
        <li class="cf"><span class="label"><?php _e('Border style', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_frame'.$i.'_content_border_style', $border_style_options); ?></li>
       </ul>
       <div class="theme_option_message2">
        <p><?php _e( 'If you set the border style to "Double", please set the border width to 3px or more.', 'tcd-seeed' ); ?></p>
       </div>
       ...
       <ul class="button_list cf">
        <li><input type="submit" class="button-ml ajax_button" value="<?php _e('Save', 'tcd-seeed'); ?>" /></li>
   ...
   <?php // アンダーライン --------------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Underline', 'tcd-seeed'); ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf qt-ul-preview-wrapper">
      <h3 class="theme_option_subbox_headline"><?php echo __('Underline', 'tcd-seeed').$i;  ?></h3>
      <div class="sub_box_content">

       <div class="admin_preview_area qt-ul-preview">
        <div>
         <span class="qt_underline inactive"><?php _e('Sample text for underline.', 'tcd-seeed'); ?></span>
         <span class="qt_underline active"><?php _e('The animation will be executed when you scroll into the screen.', 'tcd-seeed'); ?></span>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-seeed' ); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('Line color', 'tcd-seeed'); ?></span><input type="text" name="dp_options[qt_underline<?php echo $i; ?>_border_color]" value="<?php echo esc_attr( $options['qt_underline'.$i.'_border_color'] ); ?>" data-default-color="#fff799" class="c-color-picker"></li>
        ...
        <li class="cf"><span class="label"><?php _e('Using animation', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_underline'.$i.'_use_animation', $bool_options); ?></li>
       </ul>
   ...
   <?php // 吹き出し --------------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Speech balloon', 'tcd-seeed');  ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <div class="sub_box cf qt-sb-preview-wrapper preview_image_wrapper">
      ...
      <?php
           if ( 1 === $i ) _e( 'Speech balloon left 1', 'tcd-seeed' );
           elseif ( 2 === $i ) _e( 'Speech balloon left 2', 'tcd-seeed' );
           elseif ( 3 === $i ) _e( 'Speech balloon right 1', 'tcd-seeed' );
           elseif ( 4 === $i ) _e( 'Speech balloon right 2', 'tcd-seeed');
      ?>
      </h3>
      <div class="sub_box_content">
       ...
       <div class="admin_preview_area qt-sb-preview">
        <div class="qt_speech_bubble <?php if($i > 2) echo 'right'; ?>">
         ...
         <div class="user">
          ...
          <span class="name"><?php _e('User name', 'tcd-seeed'); ?></span>
         </div>
         <div class="content"><span class="before"></span><?php _e('The speech balloon can be set to a user name, image, and color.', 'tcd-seeed'); ?><span class="after"></span></div>
        </div>
       </div>

       <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-seeed'); ?></h4>
       <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('User name', 'tcd-seeed'); ?></span><input class="regular-text" name="dp_options[qt_speech_balloon<?php echo $i; ?>_user_name]" type="text" value="<?php echo esc_attr( $options['qt_speech_balloon'.$i.'_user_name'] ); ?>"></li>
        ...
        <li class="cf"><span class="label"><?php _e( 'User image', 'tcd-seeed' ); ?><span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-seeed'), '80', '80'); ?></span></span><?php echo tcd_media_image_uploader($options, 'qt_speech_balloon'.$i.'_user_image', 'full'); ?></li>
       </ul>
   ...
   <div class="theme_option_field cf theme_option_field_ac qt-gm-preview-wrapper preview_image_wrapper">
    <h3 class="theme_option_headline"><?php _e( 'Google Maps', 'tcd-seeed' );  ?></h3>
    <div class="theme_option_field_ac_content">

     <div class="theme_option_message2">
      <p><?php _e('You can set styles of marker in Google Maps using this option.', 'tcd-seeed');  ?></p>
     </div>
     ...
     <div id="qt_google_map">
      <div class="admin_preview_area qt-gm-preview">
       <div class="qt_gmap">
        ...
        <span class="marker custom text"><?php _e( 'MAP', 'tcd-seeed' ); ?></span>
     ...
     <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-seeed' ); ?></h4>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('API key', 'tcd-seeed'); ?></span><input class="full_width" type="text" name="dp_options[qt_gmap_api_key]" value="<?php echo esc_attr( $options['qt_gmap_api_key'] ); ?>" /></li>
      <li class="cf"><span class="label"><?php _e('Map design', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_access_saturation', $google_map_design_options); ?></li>
      <li class="cf"><span class="label"><?php _e('Marker type', 'tcd-seeed'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_gmap_marker_type', $google_map_marker_options); ?></li>
     </ul>

     <h4 class="theme_option_headline2 qt_gmap_marker_type1"><?php _e( 'Custom marker setting', 'tcd-seeed' ); ?></h4>
     <ul class="option_list qt_gmap_marker_type1">
      ...
      <li class="cf qt_gmap_marker_type2"><span class="label"><?php _e('Images used for markers', 'tcd-seeed'); ?><span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-seeed'), '60', '20'); ?></span></span><?php echo tcd_media_image_uploader($options, 'qt_gmap_marker_img', 'medium'); ?></li>
     </ul>

     <div class="theme_option_message2">
      <p><?php _e( 'In order to display Google Maps, you need to enter your API key. For details on how to obtain an API key, please see below.', 'tcd-seeed' ); ?></br><a href="https://tcd-theme.com/2018/08/google-maps-platform-api.html" target="_blank" rel="noopener noreferrer"><?php _e('How to get a Google Maps Platform API key and notes', 'tcd-seeed'); ?></a></p>
     </div>
   ...
   <?php // プラン一覧 ----------------------------------------- ?>
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Plan list', 'tcd-seeed');  ?></h3>
    <div class="theme_option_field_ac_content">

     <div class="front_page_image">
      <img src="<?php echo esc_url(get_template_directory_uri()); ?>/admin/img/plan_list.jpg" alt="" title="" />
     </div>

     <div class="theme_option_message2">
      <p><?php _e('Please copy and paste the short code below where you want to display plan list.', 'tcd-seeed'); ?></p>
      <p><?php _e( 'Short code', 'tcd-seeed' ); ?> : <input style="background:#fff; width:200px;" type="text" onfocus="this.select();" value="[tcd_price_table]" readonly></p>
      <p><?php _e('Leave the "Headline" field blank if you don\'t want to display specific plan.<br>If you want a particular plan to stand out, please check the "Highlighting" checkbox.<br>You can change the plan order by dragging headline left or right.<br>You can change the data order by dragging data up or down.', 'tcd-seeed'); ?></p>
     </div>

     <div id="plan_list_wrap">

      <?php //繰り返しフィールド ----- ?>
      <div class="repeater-wrapper">
       <input type="hidden" name="dp_options[plan_list]" value="">
       <div class="repeater sortable" data-delete-confirm="<?php _e( 'Delete this plan?', 'tcd-seeed' ); ?>">
        <?php
             if ( $options['plan_list'] ) :
               foreach ( $options['plan_list'] as $key => $value ) :
        ?>
        <div class="plan_list repeater-item repeater-item-<?php echo esc_attr( $key ); ?>">

         <h4 class="headline plan_list_handler_parent"><span><?php _e( 'Plan', 'tcd-seeed' ); echo esc_attr( $key+1 ); ?></span><a href="#" class="button-delete-row"></a></h4>

         <ul class="plan_list_header">
          <li><label><input name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][active]" type="checkbox" value="1" <?php checked( $value['active'], 1 ); ?>><?php _e( 'Highlighting', 'tcd-seeed' ); ?></label></li>
          <li><input class="plan_list_label" type="text" placeholder="<?php _e( 'Plan name', 'tcd-seeed' ); ?>" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][headline]" value="<?php echo esc_attr($value['headline']); ?>" ></li>
          <li class="price"><input type="text" placeholder="<?php _e( 'Price', 'tcd-seeed' ); ?>" class="num" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][num]" value="<?php echo esc_attr($value['num']); ?>" ><input type="text" placeholder="<?php _e( 'Unit', 'tcd-seeed' ); ?>" class="unit" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][unit]" value="<?php echo esc_attr($value['unit']); ?>" ></li>
          <li><textarea placeholder="<?php _e( 'Description', 'tcd-seeed' ); ?>" cols="50" rows="3" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][desc]"><?php echo esc_textarea($value['desc']); ?></textarea></li>
          <li><input type="text" placeholder="<?php _e( 'Button label', 'tcd-seeed' ); ?>" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][button]" value="<?php echo esc_attr($value['button']); ?>" ></li>
          <li>
           <div class="admin_link_option" style="max-width:inherit; float:none;">
            <input type="text" placeholder="<?php _e( 'Button URL', 'tcd-seeed' ); ?>" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][url]" value="<?php echo esc_attr($value['url']); ?>" >
            <input id="plan_list_target_<?php echo $key; ?>" class="admin_link_option_target" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][target]" type="checkbox" value="1" <?php checked( $value['target'], 1 ); ?>>
            <label for="plan_list_target_<?php echo $key; ?>">&#xe920;</label>
           </div>
          </li>
         </ul>
         ...
         <div class="repeater-wrapper">
          <div class="plan_data">
           <div class="repeater sortable" data-delete-confirm="<?php _e( 'Delete this row?', 'tcd-seeed' ); ?>">
            <input type="hidden" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][item_list]" value="">
            <?php
                 $item_list_default_values = array(
                   'data_left' => '',
                   'data_right' => '',
                 );
                 if ( ! empty( $value['item_list'] ) && is_array( $value['item_list'] ) ) :
                   foreach ( $value['item_list'] as $key2 => $value2 ) :
                     $value2 = array_merge( $item_list_default_values, $value2 );
            ?>
            <div class="repeater-item repeater-item-<?php echo esc_attr( $key ); ?>-<?php echo esc_attr( $key2 ); ?>">
             <div class="data">
              <div class="plan_list_handler"><span class="c-icon">&#xe25d;</span></div>
              <input class="left" type="text" placeholder="<?php _e( 'Headline', 'tcd-seeed' ); ?>" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][item_list][<?php echo esc_attr( $key2 ); ?>][data_left]" value="<?php echo esc_textarea( $value2['data_left'] ); ?>" />
              <input class="right" type="text" placeholder="<?php _e( 'Data', 'tcd-seeed' ); ?>" name="dp_options[plan_list][<?php echo esc_attr( $key ); ?>][item_list][<?php echo esc_attr( $key2 ); ?>][data_right]" value="<?php echo esc_textarea( $value2['data_right'] ); ?>" />
              <div class="col-delete"><a href="#" class="button-delete-row"></a></div>
             </div>
            </div>
            <?php
                   endforeach;
                 ...
                 $key2 = 'clone02index';
                 $value2 = $item_list_default_values;
                 ob_start();
            ?>
            <div class="repeater-item repeater-item-<?php echo esc_attr( $key ); ?>-<?php echo esc_attr( $key2 ); ?>">
             <div class="data">
          ...
          <a href="#" class="button button-secondary button-add-row" data-clone="<?php echo htmlspecialchars( $clone2 ); ?>" data-add-index="<?php echo esc_attr( $key2 ); ?>"><?php _e( 'Add new data', 'tcd-seeed' ); ?></a>
        ...
        <?php
             ...
             ob_start();
        ?>
        <div class="plan_list repeater-item repeater-item-<?php echo $key; ?>">

         <h4 class="headline plan_list_handler_parent"><span><?php _e( 'New plan', 'tcd-seeed' ); ?></span><a href="#" class="button-delete-row"></a></h4>
         ...
         <div class="repeater-wrapper">
          <div class="plan_data">
           <div class="repeater sortable" data-delete-confirm="<?php _e( 'Delete this row?', 'tcd-seeed' ); ?>">
            <input type="hidden" name="dp_options[test_list][<?php echo esc_attr( $key ); ?>][item_list]" value="">
            <?php
                 $item_list_default_values = array(
                   'data_left' => '',
                   'data_right' => '',
                 );
                 if ( ! empty( $value['item_list'] ) && is_array( $value2['item_list'] ) ) :
                   foreach ( $value['item_list'] as $key2 => $value2 ) :
                     $value2 = array_merge( $item_list_default_values, $value2 );
            ?>
            <div class="repeater-item repeater-item-<?php echo esc_attr( $key ); ?>-<?php echo esc_attr( $key2 ); ?>">
       ...
       <div id="add_new_plan">
        <a href="#" class="button button-secondary button-add-row" data-clone="<?php echo htmlspecialchars( $clone ); ?>"><?php _e( 'Add new plan', 'tcd-seeed' ); ?></a>
       </div>
      </div><!-- END .repeater-wrapper -->
      <?php //繰り返しフィールドここまで ----- ?>

     </div><!-- END #plan_list_wrap -->
