jQuery(document).ready(function($){
  ...
  // 導入事例の並び替え
  $(".data_list_repeater").sortable({
    placeholder: "repeater_item_placeholder",
    handle: '.repeater_handler',
    //helper: "clone",
    start: function(e, ui){
  ...
  // アイテムを削除する
  $(".data_list_repeater_wrap").on("click", ".repeater_delete_row", function() {
    var del = true;
    var confirm_message = $(this).closest(".data_list_repeater").attr("data-delete-confirm");
    if (confirm_message) {
  ...
  // 新しいアイテムを追加する
  $(".data_list_repeater_wrap").off("click", ".repeater_add_row").on("click", ".repeater_add_row", function() {
    var next_index = $(".data_list_repeater_wrap").find(".data_list_repeater:first > .repeater_item").length || 0;
    var clone = $(this).attr("data-clone");
    var $parent = $(this).closest(".data_list_repeater_wrap");
    if (clone && $parent.size()) {
      ...
      $parent.find(".data_list_repeater:first").append(clone);
    }
    return false;
  });
  ...
  // プラン一覧
  $(document).on('change keyup', '.plan_list_label', function(){
    $(this).closest('.plan_list').find('.headline span').text($(this).val());
  });
  $('.plan_list_label').each(function(){
    if( $(this).val() != "" ){
      $(this).closest('.plan_list').find('.headline span').text($(this).val());
    }
  });
  ...
  // 事例カテゴリー
  $(document).on('click', '#show_case_study_category_list_bg_image_display', function(event){
    if ($(this).prop("checked")) {
      $('.case_study_category_list_bg_image_option').show();
    }
  });
  $(document).on('click', '#show_case_study_category_list_bg_image_hide', function(event){
    if ($(this).prop("checked")) {
      $('.case_study_category_list_bg_image_option').hide();
    }
  });
  $('#show_case_study_category_list_bg_image_display').each(function(){
    if ($(this).prop("checked")) {
      $('.case_study_category_list_bg_image_option').show();
    }
  });
  $('#show_case_study_category_list_bg_image_hide').each(function(){
    if ($(this).prop("checked")) {
      $('.case_study_category_list_bg_image_option').hide();
    }
  });
  ...
  // サービス記事一覧
  $(document).on('click', '#archive_service_list_type1', function(event){
    if ($(this).prop("checked")) {
      $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').removeClass('deactive');
      $('.service_list_post_num_option, .service_list_post_num_option_notice').addClass('deactive');
      $('.service_related_post, .service_related_post_notice').addClass('deactive');
      $('.cb_service_list_type1_option').show();
      $('.cb_service_list_type2_option').hide();
      $('.service_icon_list_type_option, .service_icon_list_type_option_notice').removeClass('deactive');
    }
  });
  $(document).on('click', '#archive_service_list_type2', function(event){
    if ($(this).prop("checked")) {
      $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').removeClass('deactive');
      $('.service_list_post_num_option, .service_list_post_num_option_notice').addClass('deactive');
      $('.service_related_post, .service_related_post_notice').addClass('deactive');
  ...
  $(document).on('click', '#archive_service_list_type3', function(event){
    if ($(this).prop("checked")) {
      $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').addClass('deactive');
      $('.service_list_post_num_option, .service_list_post_num_option_notice').removeClass('deactive');
      $('.service_related_post, .service_related_post_notice').addClass('deactive');
      $('.cb_service_list_type1_option').show();
      $('.cb_service_list_type2_option').hide();
      $('.service_icon_list_type_option, .service_icon_list_type_option_notice').removeClass('deactive');
  ...
  $(document).on('click', '#archive_service_list_type4', function(event){
    if ($(this).prop("checked")) {
      $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').removeClass('deactive');
      $('.service_list_post_num_option, .service_list_post_num_option_notice').removeClass('deactive');
      $('.service_related_post, .service_related_post_notice').removeClass('deactive');
      $('.cb_service_list_type1_option').hide();
      $('.cb_service_list_type2_option').show();
      $('.service_icon_list_type_option, .service_icon_list_type_option_notice').addClass('deactive');
    }
  });
  if ($('#archive_service_list_type1').prop("checked")) {
    $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').removeClass('deactive');
    $('.service_list_post_num_option, .service_list_post_num_option_notice').addClass('deactive');
    $('.service_related_post, .service_related_post_notice').addClass('deactive');
    $('.cb_service_list_type1_option').show();
  ...
  if ($('#archive_service_list_type2').prop("checked")) {
    $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').removeClass('deactive');
    $('.service_list_post_num_option, .service_list_post_num_option_notice').addClass('deactive');
    $('.service_related_post, .service_related_post_notice').addClass('deactive');
    $('.cb_service_list_type1_option').show();
  ...
  if ($('#archive_service_list_type3').prop("checked")) {
    $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').addClass('deactive');
    $('.service_list_post_num_option, .service_list_post_num_option_notice').removeClass('deactive');
    $('.service_related_post, .service_related_post_notice').addClass('deactive');
    $('.cb_service_list_type1_option').show();
  ...
  if ($('#archive_service_list_type4').prop("checked")) {
    $('.service_list_title_font_size_option, .service_list_title_font_size_option_notice').removeClass('deactive');
    $('.service_list_post_num_option, .service_list_post_num_option_notice').removeClass('deactive');
    $('.service_related_post, .service_related_post_notice').removeClass('deactive');
    $('.cb_service_list_type1_option').hide();
  ...
  // CB サービス一覧
  $(document).on('click', '.cb_service_post_type1', function(event){
    if ($(this).prop("checked")) {
      $(this).closest('.option_list').find('.cb_service_post_type1_option').show();
      $(this).closest('.option_list').find('.cb_service_post_type2_option').hide();
    };
  });
  $(document).on('click', '.cb_service_post_type2', function(event){
    if ($(this).prop("checked")) {
      $(this).closest('.option_list').find('.cb_service_post_type1_option').hide();
      $(this).closest('.option_list').find('.cb_service_post_type2_option').show();
    };
  });
  $('.cb_service_post_type1').each(function(){
    if ($(this).prop("checked")) {
      $(this).closest('.option_list').find('.cb_service_post_type1_option').show();
      $(this).closest('.option_list').find('.cb_service_post_type2_option').hide();
    };
  });
  $('.cb_service_post_type2').each(function(){
    if ($(this).prop("checked")) {
      $(this).closest('.option_list').find('.cb_service_post_type1_option').hide();
      $(this).closest('.option_list').find('.cb_service_post_type2_option').show();
    };
  ...
  // フッターのコンタクト
  $(document).on('click', '#footer_contact_bg_type1', function(event){
    if ($(this).prop("checked")) {
      $('#footer_bg_type1_option').show();
      $('#footer_bg_type2_option').hide();
      $('#footer_bg_type3_option').hide();
      $('.footer_bg_overlay_option').show();
    }
  });
  $(document).on('click', '#footer_contact_bg_type2', function(event){
    if ($(this).prop("checked")) {
  ...
  $(document).on('click', '#footer_contact_bg_type3', function(event){
    if ($(this).prop("checked")) {
      $('#footer_bg_type1_option').hide();
      $('#footer_bg_type2_option').hide();
      $('#footer_bg_type3_option').show();
      $('.footer_bg_overlay_option').show();
    }
  });
  $(document).on('click', '#footer_contact_bg_none', function(event){
    if ($(this).prop("checked")) {
      $('#footer_bg_type1_option').hide();
      $('#footer_bg_type2_option').hide();
      $('#footer_bg_type3_option').hide();
      $('.footer_bg_overlay_option').hide();
    }
  });
  if ($('#footer_contact_bg_type1').prop("checked")) {
    $('#footer_bg_type1_option').show();
    $('#footer_bg_type2_option').hide();
    $('#footer_bg_type3_option').hide();
    $('.footer_bg_overlay_option').show();
  }
  if ($('#footer_contact_bg_type2').prop("checked")) {
    $('#footer_bg_type1_option').hide();
    $('#footer_bg_type2_option').show();
    $('#footer_bg_type3_option').hide();
    $('.footer_bg_overlay_option').show();
  }
  if ($('#footer_contact_bg_type3').prop("checked")) {
    $('#footer_bg_type1_option').hide();
    $('#footer_bg_type2_option').hide();
    $('#footer_bg_type3_option').show();
    $('.footer_bg_overlay_option').show();
  }
  if ($('#footer_contact_bg_none').prop("checked")) {
    $('#footer_bg_type1_option').hide();
    $('#footer_bg_type2_option').hide();
    $('#footer_bg_type3_option').hide();
    $('.footer_bg_overlay_option').hide();
    ...
    // セールスポイント
    $(document).on('click', '.sp_layout_type1', function(event){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.one_column_option').show();
        $(this).closest('.sub_box_tab_content').find('.two_column_option').hide();
      };
    });
    $(document).on('click', '.sp_layout_type2', function(event){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.one_column_option').hide();
        $(this).closest('.sub_box_tab_content').find('.two_column_option').show();
      };
    });
    $(document).on('click', '.sp_sub_content_type_type1', function(event){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.sub_content_type1_option').show();
        $(this).closest('.sub_box_tab_content').find('.sub_content_type2_option').hide();
      };
    });
    $(document).on('click', '.sp_sub_content_type_type2', function(event){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.sub_content_type1_option').hide();
        $(this).closest('.sub_box_tab_content').find('.sub_content_type2_option').show();
      };
    });

    $('.sp_layout_type1').each(function(){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.one_column_option').show();
        $(this).closest('.sub_box_tab_content').find('.two_column_option').hide();
      };
    });
    $('.sp_layout_type2').each(function(){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.one_column_option').hide();
        $(this).closest('.sub_box_tab_content').find('.two_column_option').show();
      };
    });
    $('.sp_sub_content_type_type1').each(function(){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.sub_content_type1_option').show();
        $(this).closest('.sub_box_tab_content').find('.sub_content_type2_option').hide();
      };
    });
    $('.sp_sub_content_type_type2').each(function(){
      if ($(this).prop("checked")) {
        $(this).closest('.sub_box_tab_content').find('.sub_content_type1_option').hide();
        $(this).closest('.sub_box_tab_content').find('.sub_content_type2_option').show();
      };
  ...
  // チャート
  $(document).on('click', '#tcd_chart_type li', function(event){
    $(this).siblings().removeClass('active');
    $(this).addClass('active');
    if ( $(this).hasClass('line')) {
      $('.chart_type4_option, .chart_line_color_option, .chart_max_num_option').show();
      $('.chart_type1_option, .chart_type2_option, .chart_type3_option, .chart_bar_width_option, .chart_bar_bg_color_option, .chart_color_option, .chart_tooltip_option, .non_line_chart').hide();
    } else if ( $(this).hasClass('bar_vertical')) {
      $('.chart_type2_option, .chart_max_num_option, .chart_bar_width_option, .chart_color_option, .bar_option, .non_line_chart').show();
      $('.chart_type1_option, .chart_type3_option, .chart_type4_option, .chart_line_color_option, .chart_bar_bg_color_option, .chart_tooltip_option, .hbar_option').hide();
    } else if ( $(this).hasClass('bar_horizontal')) {
      $('.chart_type3_option, .chart_max_num_option, .chart_bar_width_option, .chart_bar_bg_color_option, .chart_color_option, .hbar_option, .non_line_chart').show();
      $('.chart_type1_option, .chart_type2_option, .chart_type4_option, .chart_line_color_option, .chart_tooltip_option, .bar_option').hide();
    } else {
      $('.chart_type1_option, .chart_color_option, .chart_tooltip_option, .non_line_chart').show();
      $('.chart_type2_option, .chart_type3_option, .chart_type4_option, .chart_line_color_option, .chart_max_num_option, .chart_bar_width_option, .chart_bar_bg_color_option').hide();
    }
  });
  $('#tcd_chart_type li').each(function(){
    if ( $(this).hasClass('line') && $('input', this).prop("checked") ) {
      $(this).siblings().removeClass('active');
      $(this).addClass('active');
      $('.chart_type4_option, .chart_line_color_option, .chart_max_num_option').show();
      $('.chart_type1_option, .chart_type2_option, .chart_type3_option, .chart_bar_width_option, .chart_bar_bg_color_option, .chart_color_option, .chart_tooltip_option, .non_line_chart').hide();
    } else if ( $(this).hasClass('bar_vertical') && $('input', this).prop("checked") ) {
      $(this).siblings().removeClass('active');
      $(this).addClass('active');
      $('.chart_type2_option, .chart_max_num_option, .chart_bar_width_option, .chart_color_option, .bar_option, .non_line_chart').show();
      $('.chart_type1_option, .chart_type3_option, .chart_type4_option, .chart_line_color_option, .chart_bar_bg_color_option, .chart_tooltip_option, .hbar_option').hide();
    } else if ( $(this).hasClass('bar_horizontal') && $('input', this).prop("checked") ) {
      $(this).siblings().removeClass('active');
      $(this).addClass('active');
      $('.chart_type3_option, .chart_max_num_option, .chart_bar_width_option, .chart_bar_bg_color_option, .chart_color_option, .hbar_option, .non_line_chart').show();
      $('.chart_type1_option, .chart_type2_option, .chart_type4_option, .chart_line_color_option, .chart_tooltip_option, .bar_option').hide();
    } else if ( ($(this).hasClass('doughnut') && $('input', this).prop("checked")) || ($(this).hasClass('pie') && $('input', this).prop("checked")) ) {
      $(this).siblings().removeClass('active');
      $(this).addClass('active');
      $('.chart_type1_option, .chart_color_option, .chart_tooltip_option, .non_line_chart').show();
      $('.chart_type2_option, .chart_type3_option, .chart_type4_option, .chart_line_color_option, .chart_max_num_option, .chart_bar_width_option, .chart_bar_bg_color_option').hide();
  ...
  $('select.cb_chart_desc_type').change(function(){
    if ( $(this).val() == 'type3' ) {
      $('.chart_desc_option').show();
    } else {
      $('.chart_desc_option').hide();
    }
  });
  $('select.cb_chart_desc_type').each(function(){
    if ( $(this).val() == 'type3' ) {
      $('.chart_desc_option').show();
    } else {
      $('.chart_desc_option').hide();
  ...
  $(document).on('click', 'label[for="show_table_show"]', function(event){
    $('.data_table_unit').show();
  });
  $(document).on('click', 'label[for="show_table_hide"]', function(event){
    $('.data_table_unit').hide();
  });
  if ($('#show_table_show').prop("checked") ) {
    $('.data_table_unit').show();
  }
  if ($('#show_table_hide').prop("checked") ) {
    $('.data_table_unit').hide();
  }
  // チャートここまで
