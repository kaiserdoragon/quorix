    ...
    <div class="contents -md">
      ...
      <dl>
        <div>
          ...
          <dd>
            一括見積り依頼や、登録企業からの返信には一切費用はかかりません。
          </dd>
        </div>
        <div>
          <dt>
          ...
          <dd>
            当サイトは、一回の見積り依頼に対し最大5社から返信がございます。<br>
            何十社から届く事はありませんので、対応に追われる事無く比較ができます。
          </dd>
        </div>
        <div>
          <dt>
            見積りが届いた後は、どうすればいいですか？
          </dt>
          <dd>
            各社から見積りが届きましたら、「サービス」「価格」など比較・検討して頂きお取引する会社と直接やり取りを行って下さい。
          </dd>
        </div>
        <div>
          <dt>
            申し込みから最短何日後の工事が可能ですか？
          </dt>
          <dd>
            最短で翌日の工事からお申し込み頂けます。<br>
            ただし、工事お申込みの時期や工事先のご地域によってはご希望を承りかねる場合がございます。<br>
            詳しくは一度お問い合わせの上、専門スタッフよりご案内させて頂きます。
          </dd>
        </div>
        <div>
          <dt>
