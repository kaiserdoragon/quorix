...
function tcd_add_quicktags() {
	...
	$tcdQuicktagsL10n = array(
		'pulldown_title' => array(
			'display' => __( 'quicktags', 'tcd-seeed' ),
		),
		'ytube' => array(
			'display' => __( 'YouTube', 'tcd-seeed' ),
			'tag' => __( '<div class="ytube">YouTube code here</div>', 'tcd-seeed' )
		),
		'relatedcardlink' => array(
			'display' => __( 'Cardlink', 'tcd-seeed' ),
			'tag' => __( '[clink url="Post URL to display"]', 'tcd-seeed' )
		),
		'post_col-2' => array(
			'display' => __( '2 column', 'tcd-seeed' ),
			'tag' => __( '<div class="post_row"><div class="post_col post_col-2">Text and image tags to display in the left column</div><div class="post_col post_col-2">Text and image tags to display in the right column</div></div>', 'tcd-seeed' )
		),
		'post_col-3' => array(
			'display' => __( '3 column', 'tcd-seeed' ),
			'tag' => __( '<div class="post_row"><div class="post_col post_col-3">Text and image tags to display in the left column</div><div class="post_col post_col-3">Text and image tags to display in the center column</div><div class="post_col post_col-3">Text and image tags to display in the right column</div></div>', 'tcd-seeed' )
		),
		'q_comment_out' => array(
			'display' => __( 'Comment out', 'tcd-seeed' ),
			'tagStart' => '<div class="hidden"><!-- ',
			'tagEnd' => ' --></div>'
		),
		'q_h2' => array(
			'display' => __( 'Styled h2 tag', 'tcd-seeed' ),
			'tagStart' => '<h2 class="styled_h2">',
			'tagEnd' => '</h2>'
		),
		'q_h3' => array(
			'display' => __( 'Styled h3 tag', 'tcd-seeed' ),
			'tagStart' => '<h3 class="styled_h3">',
			'tagEnd' => '</h3>'
		),
		'q_h4' => array(
			'display' => __( 'Styled h4 tag', 'tcd-seeed' ),
			'tagStart' => '<h4 class="styled_h4">',
			'tagEnd' => '</h4>'
		),
		'q_h5' => array(
			'display' => __( 'Styled h5 tag', 'tcd-seeed' ),
			'tagStart' => '<h5 class="styled_h5">',
			'tagEnd' => '</h5>'
		),
		'q_ol' => array(
			'display' => __( 'Styled ol', 'tcd-seeed' ),
			'tag' => '<ol class="q_styled_ol">'."\n".'<li>'.__('List', 'tcd-seeed').'1</li>'."\n".'<li>'.__('List', 'tcd-seeed').'2</li>'."\n".'<li>'.__('List', 'tcd-seeed').'3</li>'."\n".'</ol>'
		),
		'gray_bg' => array(
			'display' => __( 'Gray background', 'tcd-seeed' ),
			'tag' => "<div class='gray_bg'>\n\n" . __('Enter content here', 'tcd-seeed') . "\n\n</div>",
		),
		'q_frame1' => array(
			'display' => __( 'Frame style', 'tcd-seeed' ).'1',
			'tagStart' => '<div class="q_frame q_frame1"><span class="q_frame_label">'.esc_html($dp_options['qt_frame1_label']).'</span>',
			'tagEnd' => '</div>'
		),
		'q_frame2' => array(
			'display' => __( 'Frame style', 'tcd-seeed' ).'2',
			'tagStart' => '<div class="q_frame q_frame2"><span class="q_frame_label">'.esc_html($dp_options['qt_frame2_label']).'</span>',
			'tagEnd' => '</div>'
		),
		'q_frame3' => array(
			'display' => __( 'Frame style', 'tcd-seeed' ).'3',
		...
		'q_custom_button1' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-seeed' ), 1 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button1">' . sprintf( __( 'Button %d', 'tcd-seeed' ), 1 ) . '</a></div>'
		),
		'q_custom_button2' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-seeed' ), 2 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button2">' . sprintf( __( 'Button %d', 'tcd-seeed' ), 2 ) . '</a></div>'
		),
		'q_custom_button3' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-seeed' ), 3 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button3">' . sprintf( __( 'Button %d', 'tcd-seeed' ), 3 ) . '</a></div>'
		),
		'q_underline1' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-seeed' ), 1 ),
			'tagStart' => '<span class="q_underline q_underline1" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'q_underline2' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-seeed' ), 2 ),
			'tagStart' => '<span class="q_underline q_underline2" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'q_underline3' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-seeed' ), 3 ),
			'tagStart' => '<span class="q_underline q_underline3" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'speech_balloon_left1' => array(
			'display' => __( 'Speech balloon left 1', 'tcd-seeed' ),
			'tagStart' => '[speech_balloon_left1]',
			'tagEnd' => '[/speech_balloon_left1]'
		),
		'speech_balloon_left2' => array(
			'display' => __( 'Speech balloon left 2', 'tcd-seeed' ),
			'tagStart' => '[speech_balloon_left2]',
			'tagEnd' => '[/speech_balloon_left2]'
		),
		'speech_balloon_right1' => array(
			'display' => __( 'Speech balloon right 1', 'tcd-seeed' ),
			'tagStart' => '[speech_balloon_right1]',
			'tagEnd' => '[/speech_balloon_right1]'
		),
		'speech_balloon_right2' => array(
			'display' => __( 'Speech balloon right 2', 'tcd-seeed' ),
			'tagStart' => '[speech_balloon_right2]',
			'tagEnd' => '[/speech_balloon_right2]'
		),
		'google_map' => array(
			'display' => __( 'Google Maps', 'tcd-seeed' ),
			'tag' => '[qt_google_map address="'. __( 'Enter address here', 'tcd-seeed' ) . '"]'
		),
		'plan_list' => array(
			'display' => __( 'Plan list', 'tcd-seeed' ),
			'tag' => '[tcd_price_table]'
		),
		'numeric_data' => array(
			'display' => __( 'Achievement data', 'tcd-seeed' ),
			'tag' => '[sc_numeric_data headline="'. __( 'Achievement title', 'tcd-seeed' ) . '" num="'. "000" . '" unit="'. __( 'Unit name', 'tcd-seeed' ) . '" desc="'. __( 'Enter supplementary explanation here', 'tcd-seeed' ) . '"]'
		),
		'tab_content' => array(
			'display' => __( 'Tab content', 'tcd-seeed' ),
			'tag' => '[tcd_tab tab1="'. __( 'Tab1 headline', 'tcd-seeed' ) . '" img1="'. __( 'Enter tab1 image url here', 'tcd-seeed' ) . '" tab2="'. __( 'Tab2 headline', 'tcd-seeed' ) . '" img2="'. __( 'Enter tab2 image url here', 'tcd-seeed' ) . '"]'
		),
		'tcd_toc' => array(
			'display' => __( 'Table of Contents', 'tcd-seeed' ),
			'tag' => '[tcd_toc]'
		),
	);
?>
...
.design_header .catch { font-size:38px; line-height:1.6; margin:0; padding:0; }
.design_header .desc { font-size:18px; }
.design_header .desc p { font-size:18px; line-height:2.4; }
.design_header .catch + .desc { margin-top:15px; }


/* デザインテーブル */
.design_table { border:none !important; }
.design_table th, .design_table td { border-color:rgba(255,255,255,0.5) !important; }
.design_table tr:first-child td { background:#238c00; color:#fff; font-weight:600 !important; }
.design_table.red_color tr:first-child td { background:#d93600; }
.design_table.blue_color tr:first-child td { background:#008c8c; }
.design_table tr:nth-child(even) td { background:#f6f6f6 !important; }
@media screen and (max-width:1000px) {
  .design_table td { padding:10px 25px; font-size:14px; }
}
@media screen and (max-width:800px) {
	.design_table { width:580px !important; margin:0 auto; }
}
