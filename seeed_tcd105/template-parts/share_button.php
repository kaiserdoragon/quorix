...
<div class="share_button_list_default">
 <ul>
  ...
  <li class="feedly_button">
     <a href='//feedly.com/i/subscription/feed%2F<?php bloginfo('rss2_url'); ?>' target='blank'><img id='feedlyFollow' src='//s3.feedly.com/img/follows/feedly-follow-rectangle-flat-small_2x.png' alt='follow us in feedly' width='66' height='20'></a>
  </li>
  <?php }; ?>
...
<div class="share_button_list <?php if($options['sns_share_design_type'] === 'type1' || $options['sns_share_design_type'] === 'type2'){ echo 'small_size'; } else { echo 'large_size'; }; if($options['sns_share_design_type'] === 'type1' || $options['sns_share_design_type'] === 'type3'){ echo ' color'; } else { echo ' mono'; }; ?>">
 <ul>
  ...
  <?php if ( $options['show_sns_share_pinterest'] ) { ?>
  <li class="pinterest_button">
   <a rel="nofollow" href="https://www.pinterest.com/pin/create/button/?url=<?php echo $url_encode; ?>&media=<?php echo $pinterestimage[0]; ?>&description=<?php echo $title_encode ?>" data-pin-do="buttonBookmark" data-pin-custom="true"><span class="label">Pin&nbsp;it</span></a>
  </li>
  <?php }; ?>
 </ul>
</div>
