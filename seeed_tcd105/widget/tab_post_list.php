...
class tab_post_list_widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __('Tab post list (tcd ver)', 'tcd-seeed'),
      array(
        'classname' => 'tab_post_list_widget',
        'description' => __('Display three type of post list by tab.', 'tcd-seeed')
      )
    );
  }
...
<div class="widget_tab_post_list_button clearfix">
 <?php
      ...
      for ( $i = 1; $i <= 2; $i++ ) :
        ...
        if($title){
 ?>
 <div class="tab<?php echo $tab_num; if($tab_num == 1){ echo ' active'; }; ?>"><?php echo esc_html($title); ?></div>
 <?php
          $tab_num++;
        };
      endfor;
...
<?php endwhile; wp_reset_query(); } else { ?>
 <li class="no_post" style="width:100%; margin-right:0;"><?php _e('There is no registered post.', 'tcd-seeed');  ?></li>
<?php }; ?>
</ol>
<?php
         $tab_num++;
  ...
  function form($instance) {
    $options = get_design_plus_option();
    $defaults = array(
      'title1' => __('Recent post', 'tcd-seeed'), 'post_num' => 3, 'content_type1' => 'post', 'post_order1' => 'date', 'post_type1' => 'recent_post',
      'title2' => __('Recommend post', 'tcd-seeed'), 'content_type2' => 'post', 'post_order2' => 'date', 'post_type2' => 'recommend_post',
    );
...
<h3 class="tcd_widget_tab_content_headline"><?php _e('First tab setting', 'tcd-seeed'); ?></h3>
<div class="tcd_widget_tab_content">

<div class="theme_option_message2" style="margin-bottom:20px;">
 <p><?php _e('Leave the title field blank if you don\'t want to display this tab.', 'tcd-seeed'); ?></p>
</div>
...
<div class="tcd_widget_content">
 <h3 class="tcd_widget_headline"><?php _e('Content type', 'tcd-seeed'); ?></h3>
...
<div class="tcd_widget_content">
 ...
 <select name="<?php echo $this->get_field_name('post_type1'); ?>" class="tab_post_list_post_type widefat" style="width:100%;">
  <option value="recent_post" <?php selected('recent_post', $instance['post_type1']); ?>><?php _e('Recent post', 'tcd-seeed'); ?></option>
  <option value="recommend_post" <?php selected('recommend_post', $instance['post_type1']); ?>><?php _e('Recommend post', 'tcd-seeed'); ?>1</option>
  <option value="recommend_post2" <?php selected('recommend_post2', $instance['post_type1']); ?>><?php _e('Recommend post', 'tcd-seeed'); ?>2</option>
  <option value="recommend_post3" <?php selected('recommend_post3', $instance['post_type1']); ?>><?php _e('Recommend post', 'tcd-seeed'); ?>3</option>
 </select>
</div>
...
<div class="tcd_widget_content widget_post_order">
 ...
 <select name="<?php echo $this->get_field_name('post_order1'); ?>" class="widefat" style="width:100%;">
  <option value="date" <?php selected('date', $instance['post_order1']); ?>><?php _e('Date', 'tcd-seeed'); ?></option>
  <option value="rand" <?php selected('rand', $instance['post_order1']); ?>><?php _e('Random', 'tcd-seeed'); ?></option>
 </select>
</div>

</div><!-- END .tcd_ad_widget_box -->

<h3 class="tcd_widget_tab_content_headline"><?php _e('Second tab setting', 'tcd-seeed'); ?></h3>
<div class="tcd_widget_tab_content">
...
<div class="tcd_widget_content">
 ...
 <select name="<?php echo $this->get_field_name('post_type2'); ?>" class="tab_post_list_post_type widefat" style="width:100%;">
  <option value="recent_post" <?php selected('recent_post', $instance['post_type2']); ?>><?php _e('Recent post', 'tcd-seeed'); ?></option>
  <option value="recommend_post" <?php selected('recommend_post', $instance['post_type2']); ?>><?php _e('Recommend post', 'tcd-seeed'); ?>1</option>
  <option value="recommend_post2" <?php selected('recommend_post2', $instance['post_type2']); ?>><?php _e('Recommend post', 'tcd-seeed'); ?>2</option>
  <option value="recommend_post3" <?php selected('recommend_post3', $instance['post_type2']); ?>><?php _e('Recommend post', 'tcd-seeed'); ?>3</option>
 </select>
</div>
...
<div class="tcd_widget_content widget_post_order">
 ...
 <select name="<?php echo $this->get_field_name('post_order2'); ?>" class="widefat" style="width:100%;">
  <option value="date" <?php selected('date', $instance['post_order2']); ?>><?php _e('Date', 'tcd-seeed'); ?></option>
  <option value="rand" <?php selected('rand', $instance['post_order2']); ?>><?php _e('Random', 'tcd-seeed'); ?></option>
 </select>
</div>
